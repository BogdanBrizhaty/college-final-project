		...
		<form action="" enctype="multipart/form-data" method="post">
			<div style="height:400px;">
				...
				<div class="form_right_col" style="height:30px;" >
					<input type="text" style="width:100%;"  name="Title" value="<?php echo $a->Title; ?>" required/>
				</div>
				<div class="form_left_col" style="height:30px;">
					Фото
				</div>
				...
				<div class="form_right_col">
					<textarea id="editor1" style="width:100%;max-width:100%; max-height:325px; height:325px;"  name="Text" required><?php echo $a->Content; ?></textarea>
				</div><br/>
			</div>
			<br/>
			<div>
