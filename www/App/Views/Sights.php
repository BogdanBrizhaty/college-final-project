<?php
			...
			<div class="green_block">
				...
				<div class="post_footer">
					...
					<div style="float:right;">
						<a href="/sights/view?id='.$s->Id.'" title="Читать далее" >
							<input type="button"  value="Читать далее" class="green_button" style="padding:3px;"/>
						</a>';
	...
	echo '<div style="text-align:center;">'.PageHelper($TotalPages, $CurrentPage, 'sights').'</div>';
?>
